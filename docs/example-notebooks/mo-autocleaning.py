...
def _(mo):
    mo.md(
        ...
        Buckaroo separates data cleaning into three steps
...
def _(pd, re, s):
    ...
    class StripIntParse(Command):
        ...
        def transform(df, col):
            ...
            _strip_parse = _ser.str.replace(
                _digits_and_period, "", regex=True
            ).apply(pd.to_numeric, errors="coerce", dtype_backend="pyarrow")

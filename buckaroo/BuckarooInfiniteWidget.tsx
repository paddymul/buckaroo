...
export default function (
    {
        ...
        payload_args, setPayload_args, payload_response
         }) {

    debugger;
    console.log("BuckarooInfiniteWidget extraComponents", extraComponents);
    ...
    return (
        <div className="buckaroo_anywidget">
            <extraComponents.default.InfiniteWidgetDCFCell
                payload_args={payload_args}
                on_payload_args={setPayload_args}

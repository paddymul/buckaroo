...
import { GridApi, GridOptions, IDatasource, ModuleRegistry, SortChangedEvent } from '@ag-grid-community/core';
import { ClientSideRowModelModule } from '@ag-grid-community/client-side-row-model';
import { getAutoSize, getGridOptions, getHeightStyle, SetColumFunc } from './DFViewer';
...
export function DFViewerInfinite({
  ...
  if (data_wrapper.data_type === "Raw") {
    ...
    const dsGridOptions = getDsGridOptions(gridOptions, data_wrapper.datasource);
    return (
      <div className={`df-viewer  ${hs.classMode} ${hs.inIframe}`}>
        <div style={hs.applicableStyle} className={`theme-hanger ${divClass}`}>
          <AgGridReact
...
const getDsGridOptions = (origGridOptions: GridOptions, datasource: IDatasource): GridOptions => {
